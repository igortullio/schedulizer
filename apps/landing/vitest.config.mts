...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@schedulizer/observability/browser': path.resolve(import.meta.dirname, '../../libs/observability/src/browser.ts'),
      '@schedulizer/observability/node': path.resolve(import.meta.dirname, '../../libs/observability/src/node.ts'),
      '@schedulizer/observability': path.resolve(import.meta.dirname, '../../libs/observability/src/index.ts'),
    },
